...
export type AbstractedInputMode = "numeric" | "none" | "text" | "tel" | "email" | "url" | "decimal" | "search";
export type AbstractedInputAutoComplete = "off" | "username" | "one-time-code" | "current-password";
export type AbstractedInputType = "text" | "password" | "number" | "tel";
export type AbstractedInputDirection = "rtl" | "ltr";

export interface AbstractedInputProps {
  autoComplete?: AbstractedInputAutoComplete;
  inputMode?: AbstractedInputMode;
  dir?: AbstractedInputDirection;
  startIcon?: IconProps;
  type?: AbstractedInputType;
...
export const AbstractedInput = forwardRef<HTMLInputElement, AbstractedInputProps>(({
  containerClassName,
  isReadOnly = false,
  inputMode = "text",
  autoFocus = false,
